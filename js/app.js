...
let sliderMain = new Swiper('.main-page__slider-body', {
	autoplay: {
		delay: 4000,
	...
	// Arrows
	navigation: {
		nextEl: '.slider-arrow-main .slider-arrow_next',
		prevEl: '.slider-arrow-main .slider-arrow_prev',
	},
});

let titleSlider = new Swiper('.title-slider__body', {
	observer: true,
	observeParents: true,
	slidesPerView: 7,
	centeredSlides: true,
	...
	// Arrows
	navigation: {
		nextEl: '.title-slider__arrows .title-slider__arrow_next',
		prevEl: '.title-slider__arrows .title-slider__arrow_prev',
	},
	breakpoints: {
		320: {
...
let infoSlider = new Swiper('.info-slider__body', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	centeredSlides: true,
...
titleSlider.controller.control = infoSlider;
infoSlider.controller.control = titleSlider;
...
let menuBg = document.querySelector(".bg");
if (iconMenu != null) {
	let delay = 500;
	let menuBody = document.querySelector(".header__menu-mob");
	iconMenu.addEventListener("click", function (e) {
		if (unlock) {
			body_lock(delay);
			iconMenu.classList.toggle("_active");
			menuBody.classList.toggle("_active");
			menuBody.style.transitionDuration = '0.5s';
...
$('.bg').on('click', function () {
	$('.bg').removeClass('_active');
	$('.header__menu-mob').toggleClass('_active');
